...
class ProductProduct(models.Model):
    ...
    sale_division_id = fields.Many2one('sale.division', string="Divisi", tracking=True)
    take_in_plant = fields.Float(string="Take In Plant", digits='Product Price', help="Potongan Harga Untuk Produk yang di ambil langsung di plant.")
